#include "../interface/ObservablesEl.h"
...
ObservablesEl::ObservablesEl ()
{

  DefaultValue_ = -9999;
  MCavailable_ = false;
  met_ = TRootMET ();
  lepton_ = TRootElectron ();
  quark1_ = TRootJet ();
  quark2_ = TRootJet ();
  hadbquark_ = TRootJet ();
  lepbquark_ = TRootJet ();
...
ObservablesEl::ObservablesEl (const TRootElectron & lepton, const TRootJet & qFromW1, const TRootJet & qFromW2, const TRootJet & bFromHadTop, const TRootJet & bFromLepTop, const TRootMET & MET,float & ChiSq_)
{
...
ObservablesEl::ObservablesEl (const TRootElectron & lepton, const TRootJet & qFromW1, const TRootJet & qFromW2, const TRootJet & bFromHadTop, const TRootJet & bFromLepTop, const TRootMET & MET)
{
  MCavailable_ = false;
  met_ = MET;
  lepton_ = lepton;
...
ObservablesEl::ObservablesEl (const TRootElectron & lepton, const TRootJet & qFromW1, const TRootJet & qFromW2, const TRootJet & bFromHadTop, const TRootMET & MET)
{
  MCavailable_ = false;
  met_ = MET;
  lepton_ = lepton;
...
ObservablesEl::ObservablesEl (const TRootElectron & lepton, const TRootJet & qFromW1, const TRootJet & qFromW2, const TRootJet & bFromHadTop, const TRootJet & bFromLepTop, const TRootMET & MET, const vector < TRootJet > &jets)
{
  jets_.clear();
  jets_ = jets;
  (*this) = ObservablesEl (lepton, qFromW1, qFromW2, bFromHadTop, bFromLepTop, MET);
    //  SetJets (jets);
}

ObservablesEl::ObservablesEl (const TRootElectron & lepton, const TRootJet & qFromW1, const TRootJet & qFromW2, const TRootJet & bFromHadTop, const TRootJet & bFromLepTop, const TRootMET & MET, const vector < TRootJet* > &jets,vector <float> values_,float & ChiSq_ )
{
  ChiSquare_= ChiSq_;
 // chi2_max=chi2_max_;
  jets_.clear();
...
//cout<<"  Parsinggggggg values  "<<jets_[i].Pt()<<"  "<<jets[i]->Pt()<<" i  "<<i<<"   "<<jets.size()<<"   qFromW1  "<< qFromW1.Pt()<<"  qFromW2  "<< qFromW2.Pt()<<"  "<<endl;
 ...
 // (*this) = ObservablesEl (lepton, qFromW1, qFromW2, bFromHadTop, bFromLepTop, jets_,MET,ChiSq_);
  (*this) = ObservablesEl (lepton, qFromW1, qFromW2, bFromHadTop, bFromLepTop, jets_,values_,MET,ChiSq_);
...
ObservablesEl::ObservablesEl (const TRootElectron & lepton, const TRootJet & qFromW1, const TRootJet & qFromW2, const TRootJet & bFromTop, const TRootMET & MET, const vector < TRootJet > &jets)
{
  jets_.clear();
  jets_ = jets;
  (*this) = ObservablesEl (lepton, qFromW1, qFromW2, bFromTop, MET);
   // SetJets (jets);
}

/*
ObservablesEl::ObservablesEl(const TRootElectron& lepton, const TRootJet& qFromW1, const TRootJet& qFromW2, const TRootJet& bFromTop,  const TRootMET& MET, const vector<TRootJet>& jets, const TRootHemisphere& hemisphere){
  (*this) = ObservablesEl(lepton, qFromW1, qFromW2, bFromTop, MET);
  SetJets(jets);
...
ObservablesEl::ObservablesEl (const ObservablesEl & obs)
{
...
ObservablesEl::ObservablesEl (const TRootElectron & lepton, const vector < TRootJet > &chijets_, const vector < TRootJet > &jets, const TRootMET & MET, string & setname ,float & ChiSq_ )
{
...
ObservablesEl::ObservablesEl (const TRootElectron & lepton, const vector < TRootJet > &jets, const TRootMET & MET, string & setname)
{
  //cout<<"  JUST EENTERED THE COMPLEX  "<<endl;
...
ObservablesEl::ObservablesEl (const TRootElectron & lepton, const TRootJet & qFromW1, const TRootJet & qFromW2, const TRootJet & bFromHadTop, const TRootJet & bFromLepTop, const vector < TRootJet > &jets, const TRootMET & MET)
{
...
ObservablesEl::ObservablesEl (const TRootElectron & lepton, const TRootJet & qFromW1, const TRootJet & qFromW2, const TRootJet & bFromHadTop, const TRootJet & bFromLepTop, const vector < TRootJet > &jets,vector<float> values_,const TRootMET & MET, float &ChiSq){
...
ObservablesEl::ObservablesEl (const TRootElectron & lepton, const TRootJet & qFromW1, const TRootJet & qFromW2, const TRootJet & bFromHadTop, const TRootJet & bFromLepTop, const vector < TRootJet > &jets, const TRootMET & MET, float &ChiSq, bool GoodChi2){
...
void ObservablesEl::SetMCInfo(const TRootParticle& lepton, const TRootMCParticle& qFromW1, const TRootMCParticle& qFromW2, const TRootJet& bFromHadTop, const TRootMCParticle& bFromLepTop, const TRootMET& MET, const vector<TRootMCParticle>& jets)
{
  MCavailable_ = true;
  metMC_ = MET;
  leptonMC_ = lepton;
...
void
ObservablesEl::ComputeVariables ()
{
DefaultValue_ = -9999;
...
if (quarkspt>0){
  ...
  float HT4jetsElMET = DefaultValue_;
...
HT = 0;
      ...
      HT4jetsElMET = 0;
      HT4jetsElMET = jets_[0].Pt () + jets_[1].Pt () + jets_[2].Pt () + jets_[3].Pt () + met_.Et () + lepton_.Pt ();
      variables_.push_back (pair < string, float >(string ("HT4jetsElMET"), HT4jetsElMET));
      RangeVariables_.push_back (pair < float, float >(0.0, 5000.));
    }
  else
    {
      ...
      variables_.push_back (pair < string, float >(string ("HT4jetsElMET"), DefaultValue_));
      RangeVariables_.push_back (pair < float, float >(0.0, 5000.));
    }
...
// if (Ttbar.M()>0)
 ...
 variables_.push_back (pair < string, float >(string ("TransMassHadTop"), DefaultValue_));
  ...
  //PtEl 
 // if (lepton_.Pt ()>10)
  variables_.push_back (pair < string, float >(string ("PtEl"), lepton_.Pt ()));
  RangeVariables_.push_back (pair < float, float >(0.0, 500.));
  ...
  //if ( lepton_.Pt()>0 )
  variables_.push_back (pair < string, float >(string ("EtaEl"), eta));
  //variables_.push_back (pair < string, float >(string ("EtaEl"), lepton_.Eta()));
  RangeVariables_.push_back (pair < float, float >(-5., 5.));
  // cout<<eta<<endl;
...
*/
   ...
   if (jets_.size()>3  )
    {
      ...
      variables_.push_back (pair < string, float >(string ("DeltaPhiMetEl"),  ROOT::Math::VectorUtil::DeltaPhi (met_, lepton_)));
      RangeVariables_.push_back (pair < float, float >(-5., 5.));
  ...
  //    RangeVariables_.push_back (pair < float, float >(0.0, 5.));
    ...
    {
      variables_.push_back (pair < string, float >(string ("DeltaPhiMetEl"),  DefaultValue_));//(met_.Phi () - lepton_.Phi ())));
      RangeVariables_.push_back (pair < float, float >(-5., 5.));
...
void ObservablesEl::setEventscaleFactor(float scaleFactor){
//not an observable, but a scale factor (weight) for an event... Is put in the ObservablesEl class for convenience code-wise... (but is not very logical from physics point of view)
//!!!Take care of fact that ObservablesElRanker might be screwed up by adding this!!!!
...
void
ObservablesEl::unsetMC ()
{
  this->MCavailable_ = false;
}

bool
ObservablesEl::isModeMC ()
{
...
void
ObservablesEl::ComputeVariables (const TRootElectron & lepton, const TRootJet & quark1, const TRootJet & quark2, const TRootJet & hadbquark, const TRootJet & lepbquark, const vector < TRootJet > &Seljets, const TRootMET & selmets, string & dss,float &ChiSq_)
{
...
pair < float, float >
ObservablesEl::Range (const string label)
{
...
pair < float, float >
ObservablesEl::Range (const char *label)
{
  for (unsigned int i = 0; i < variables_.size (); i++)
    {
...
float
ObservablesEl::Variable (const string label)
{
  for (unsigned int i = 0; i < variables_.size (); i++)
    {
      if (label == variables_[i].first)
...
float
ObservablesEl::Variable (const char *label)
{
  for (unsigned int i = 0; i < variables_.size (); i++)
    if (!strcmp (label, variables_[i].first.c_str ()))
      return variables_[i].second;
...
float
ObservablesEl::VariableMC (const string label)
{
...
float
ObservablesEl::VariableMC (const char *label)
{
  for (unsigned int i = 0; i < variablesMC_.size (); i++)
...
vector < string > ObservablesEl::ListOfVariables ()
{
  vector < string > out;
  for (unsigned int i = 0; i < variables_.size (); i++)
...
vector < string > ObservablesEl::ListOfVariablesMC ()
{
  vector < string > out;
  for (unsigned int i = 0; i < variablesMC_.size (); i++)
...
/* ObservablesEl for MC need to be filled in the same order as the RECO observables (even if not available for all) */
vector < string > ObservablesEl::ListOfVariablesCoupled ()
{
  vector < string > out;
  bool
    stop = false;
