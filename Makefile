...
ROOTLIBS        = $(shell root-config --libs) -lMinuit -lMathMore -lMinuit2 -lFoam -lTMVA
ROOTLIBS_NoTMVA = $(shell root-config --libs) -lMinuit -lMathMore -lMinuit2 -lFoam
ROOTGLIBS       = $(shell root-config --glibs) -lMinuit -lMathMore -lMinuit2 -lFoam -lTMVA
