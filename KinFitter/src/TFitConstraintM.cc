  ...
  ,_ParList2(0)
{
  ...
  if (Mass >= 0) {
    ...
    cout << "NegativeMassConstr: Mass constraint in TFitConstraintM cannot be set to a negative value, will be set to 0." << endl;
    _TheMassConstraint = 0.;
  }
}
