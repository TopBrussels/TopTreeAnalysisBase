#include <iostream>
#include "../interface/TopologyWorker.h"
#include "TMatrix.h"
#include "math.h"

using namespace std;

Int_t TopologyWorker::m_maxpart = 20;
...
result+=0.5 * (elo*elo-(30*30))*(njets);
result/=((125*125)-125)/2.0;
m_njetsweighed=result;
}

void TopologyWorker::CalcWmul105(){
...
result+=0.5 * (elo*elo-(30*30))*(njets);
result/=((105*105)-105)/2.0;
m_njetsweighed105=result;
}

void TopologyWorker::CalcWmul115(){
...
result+=0.5 * (elo*elo-(30*30))*(njets);
result/=((115*115)-115)/2.0;
m_njetsweighed115=result;
}

void TopologyWorker::CalcWmul135(){
...
result+=0.5 * (elo*elo-(30*30))*(njets);
result/=((135*135)-135)/2.0;
m_njetsweighed135=result;
}

void TopologyWorker::CalcWmul145(){
...
result+=0.5 * (elo*elo-(30*30))*(njets);
result/=((145*145)-145)/2.0;
m_njetsweighed145=result;
}

void TopologyWorker::CalcWmul160(){
...
result+=0.5 * (elo*elo-(30*30))*(njets);
result/=((160*160)-160)/2.0;
m_njetsweighed160=result;
}
